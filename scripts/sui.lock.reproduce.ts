...
const Config = {
  SUI_TESTNET : {
    ...
    deployerSeed: "royal reopen journey royal enlist vote core cluster shield slush hill sample"
  },
  SUI_MAINNET : {
...
const TestWallets = [
  {
    address: "0xd58fa2a3aca4d0083a17c4021a0b52cc42bd3b81389792dc088f1f2a61bd045f",
    seedPhrase: "winter ritual relief help opera west upset syrup pelican race pig cupboard",
    signer: undefined,
  },
  {
    address: "0x331ac99092385eef4b7b21119d7e7768b19f64bf64f046665c61719cedcb5b4b",
    seedPhrase: "nuclear sing before must grape castle zero solar surge token daring parrot",
    signer: undefined,
  },
  {
    address: "0x0adb709d5387a02378f40753c0f103551b79d6dda6a534bed984dad38373ad89",
    seedPhrase: "breeze student tool soon toddler artist head then snap script phrase antenna",
    signer: undefined,
  }
]
...
async function main() {
  ...
  for(const depositPromise of depositPromises) {
    try {
      ...
      if (errString.indexOf("a quorum of validators because of locked objects") >= 0) {
